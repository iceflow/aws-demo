...
#Ctrip
ROLE_ARN=arn:aws:iam::671660153913:role/get-s3-inventory-list-role
INVENTORY_BUCKET=ctripcorp-nephele-tmp-ireland

INVENTORY_DIR=s3://ctripcorp-nephele-tmp-ireland/ctripcorp-nephele-file-ireland/test/2017-09-21T18-09Z
QUEUE_ENDPOINT="https://eu-west-1.queue.amazonaws.com/888250974927/s3-copy-list"
DST_BUCKET=ireland-leo-test
LOCAL_INVENTORY_DIR=inventory_files_copied
...
function get_temp_credential() {
    ...
    echo "aws --profile default sts assume-role --role-arn ${ROLE_ARN} --role-session-name test --output json > ${TEMP_CREDENTIAL_FILE}"
    ...
    aws s3 sync s3://ctrip-cdn-logs/ ctrip-cdn-logs/
