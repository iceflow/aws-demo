...
aws emr create-cluster --termination-protected --applications  \
    ...
    --ec2-attributes '{"KeyName":"us-east-1-test","InstanceProfile":"EMR_EC2_DefaultRole","SubnetId":"subnet-75daa702"}' \
    --release-label emr-5.8.0 \
    --log-uri 's3n://aws-logs-888250974927-us-east-1/elasticmapreduce/' \
