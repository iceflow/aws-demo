...
#bucket = s3.Bucket('leopublic')

#for obj in bucket.objects.filter(Prefix='reInvent2015/'):
#	print obj.key


#obj = s3.Object('leopublic','a.mp4')

#print obj.StorageClass

#A="AWS re_Invent 2015 _ (ARC302) Running Lean Architectures_ Optimizing for Cost Efficiency - YouTube [720p].mp4"

#print(urllib.quote_plus(A))

#print('https://s3.cn-north-1.amazonaws.com.cn/leopublic/reInvent2015/Architecture/{0}'%(urllib.quote(A)))



#O="https://s3.cn-north-1.amazonaws.com.cn/leopublic/reInvent2015/Architecture/AWS+re_Invent+2015+_+(ARC302)+Running+Lean+Architectures_+Optimizing+for+Cost+Efficiency+-+YouTube+%5B720p%5D.mp4" 
